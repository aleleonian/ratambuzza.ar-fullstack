async function insertPostcard(db, userId, tripId, avatars, scene, action, caption) {
    const sql = `
...
module.exports = { getTripMembersAvatars, insertPostcard, getNextPendingJob, updateJobStatus }